ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:arlemite_ingot", // seed item
        ["divinerpg:arlemite"], // categories that this crop can be planted on
        { block: "divinerpg:arlemite_ore" }, // display block
        [
            Item.of ("divinerpg:arlemite_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:arlemite_block", // the item that this soil is attached to
        { block: "divinerpg:arlemite_block" }, // display block
        ["divinerpg:arlemite"], // categories that this soil provides
