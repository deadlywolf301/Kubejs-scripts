ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "minecraft:clay_ball", // seed item
        ["minecraft:clay"], // categories that this crop can be planted on
        { block: "minecraft:clay" }, // display block
        [
            Item.of ("minecraft:clay_ball") // item
    ...
    event.recipes.botanypots.soil(
        "minecraft:clay", // the item that this soil is attached to
        { block: "minecraft:clay" }, // display block
        ["minecraft:clay"], // categories that this soil provides
