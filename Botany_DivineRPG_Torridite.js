ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:torridite_ingot", // seed item
        ["divinerpg:torridite"], // categories that this crop can be planted on
        { block: "divinerpg:torridite_ore" }, // display block
        [
            Item.of ("divinerpg:torridite_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:torridite_block", // the item that this soil is attached to
        { block: "divinerpg:torridite_block" }, // display block
        ["divinerpg:torridite"], // categories that this soil provides
