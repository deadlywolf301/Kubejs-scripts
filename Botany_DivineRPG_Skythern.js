ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:skythern_fragments", // seed item
        ["divinerpg:skythern"], // categories that this crop can be planted on
        { block: "divinerpg:skythern_ore" }, // display block
        [
            Item.of ("divinerpg:skythern_fragments") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:skythern_block", // the item that this soil is attached to
        { block: "divinerpg:skythern_block" }, // display block
        ["divinerpg:skythern"], // categories that this soil provides
