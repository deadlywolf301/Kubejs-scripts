ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:oxdrite_ingot", // seed item
        ["divinerpg:oxdrite"], // categories that this crop can be planted on
        { block: "divinerpg:oxdrite_ore" }, // display block
        [
            Item.of ("divinerpg:oxdrite_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:oxdrite_block", // the item that this soil is attached to
        { block: "divinerpg:oxdrite_block" }, // display block
        ["divinerpg:oxdrite"], // categories that this soil provides
