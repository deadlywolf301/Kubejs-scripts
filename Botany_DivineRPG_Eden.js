ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:eden_fragments", // seed item
        ["divinerpg:eden"], // categories that this crop can be planted on
        { block: "divinerpg:eden_ore" }, // display block
        [
            Item.of ("divinerpg:eden_fragments") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:eden_block", // the item that this soil is attached to
        { block: "divinerpg:eden_block" }, // display block
        ["divinerpg:eden"], // categories that this soil provides
