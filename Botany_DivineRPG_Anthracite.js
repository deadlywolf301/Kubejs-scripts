ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:anthracite", // seed item
        ["divinerpg:anthracite"], // categories that this crop can be planted on
        { block: "divinerpg:anthracite_ore" }, // display block
        [
            Item.of ("divinerpg:anthracite") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:coalstone", // the item that this soil is attached to
        { block: "divinerpg:coalstone" }, // display block
        ["divinerpg:anthracite"], // categories that this soil provides
