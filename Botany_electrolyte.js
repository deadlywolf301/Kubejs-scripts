ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "ad_extendra:electrolyte_ingot", // seed item
        ["ad_extendra:electrolyte_block"], // categories that this crop can be planted on
        { block: "ad_extendra:sedna_electrolyte_ore" }, // display block
        [
            Item.of ("ad_extendra:electrolyte_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "ad_extendra:electrolyte_block", // the item that this soil is attached to
        { block: "ad_extendra:electrolyte_block" }, // display block
        ["ad_extendra:electrolyte_block"], // categories that this soil provides
