ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "ad_extendra:neptunium_ingot", // seed item
        ["ad_extendra:neptunium_block"], // categories that this crop can be planted on
        { block: "ad_extendra:neptunium_block" }, // display block
        [
            Item.of("ad_extendra:neptunium_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "ad_extendra:neptunium_block", // the item that this soil is attached to
        { block: "ad_extendra:neptunium_block" }, // display block
        ["ad_extendra:neptunium_block"], // categories that this soil provides
