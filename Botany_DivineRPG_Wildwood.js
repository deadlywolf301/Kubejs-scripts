ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:wildwood_fragments", // seed item
        ["divinerpg:wildwood"], // categories that this crop can be planted on
        { block: "divinerpg:wildwood_ore" }, // display block
        [
            Item.of ("divinerpg:wildwood_fragments") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:wildwood_block", // the item that this soil is attached to
        { block: "divinerpg:wildwood_block" }, // display block
        ["divinerpg:wildwood"], // categories that this soil provides
