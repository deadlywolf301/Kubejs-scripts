ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:mortum_fragments", // seed item
        ["divinerpg:mortum"], // categories that this crop can be planted on
        { block: "divinerpg:mortum_ore" }, // display block
        [
            Item.of ("divinerpg:mortum_fragments") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:mortum_block", // the item that this soil is attached to
        { block: "divinerpg:mortum_block" }, // display block
        ["divinerpg:mortum"], // categories that this soil provides
