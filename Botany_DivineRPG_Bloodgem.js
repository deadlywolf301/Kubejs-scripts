ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:bloodgem", // seed item
        ["divinerpg:bloodgem"], // categories that this crop can be planted on
        { block: "divinerpg:bloodgem_ore" }, // display block
        [
            Item.of ("divinerpg:bloodgem") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:bloodgem_block", // the item that this soil is attached to
        { block: "divinerpg:bloodgem_block" }, // display block
        ["divinerpg:bloodgem"], // categories that this soil provides
