ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "ad_extendra:plutonium_ingot", // seed item
        ["ad_extendra:plutonium_block"], // categories that this crop can be planted on
        { block: "ad_extendra:pluto_plutonium_ore" }, // display block
        [
            Item.of("ad_extendra:plutonium_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "ad_extendra:plutonium_block", // the item that this soil is attached to
        { block: "ad_extendra:plutonium_block" }, // display block
        ["ad_extendra:plutonium_block"], // categories that this soil provides
