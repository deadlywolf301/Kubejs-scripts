ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "ad_extendra:saturlyte_ingot", // seed item
        ["ad_extendra:saturlyte_block"], // categories that this crop can be planted on
        { block: "ad_extendra:saturn_saturlyte_ore" }, // display block
        [
            Item.of("ad_extendra:saturlyte_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "ad_extendra:saturlyte_block", // the item that this soil is attached to
        { block: "ad_extendra:saturlyte_block" }, // display block
        ["ad_extendra:saturlyte_block"], // categories that this soil provides
