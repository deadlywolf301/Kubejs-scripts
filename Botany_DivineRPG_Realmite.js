ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:realmite_ingot", // seed item
        ["divinerpg:realmite"], // categories that this crop can be planted on
        { block: "divinerpg:realmite_ore" }, // display block
        [
            Item.of ("divinerpg:realmite_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:realmite_block", // the item that this soil is attached to
        { block: "divinerpg:realmite_block" }, // display block
        ["divinerpg:realmite"], // categories that this soil provides
