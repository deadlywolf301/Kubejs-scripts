ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:apalachia_fragments", // seed item
        ["divinerpg:apalachia"], // categories that this crop can be planted on
        { block: "divinerpg:apalachia_ore" }, // display block
        [
            Item.of ("divinerpg:apalachia_fragments") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:apalachia_block", // the item that this soil is attached to
        { block: "divinerpg:apalachia_block" }, // display block
        ["divinerpg:apalachia"], // categories that this soil provides
