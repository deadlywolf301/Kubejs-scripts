ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "divinerpg:rupee_ingot", // seed item
        ["divinerpg:rupee"], // categories that this crop can be planted on
        { block: "divinerpg:rupee_ore" }, // display block
        [
            Item.of ("divinerpg:rupee_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "divinerpg:rupee_block", // the item that this soil is attached to
        { block: "divinerpg:rupee_block" }, // display block
        ["divinerpg:rupee"], // categories that this soil provides
