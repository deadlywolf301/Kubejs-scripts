ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "ad_extendra:radium_ingot", // seed item
        ["ad_extendra:radium_block"], // categories that this crop can be planted on
        { block: "ad_extendra:orcus_radium_ore" }, // display block
        [
            Item.of("ad_extendra:radium_ingot") // item
    ...
    event.recipes.botanypots.soil(
        "ad_extendra:radium_block", // the item that this soil is attached to
        { block: "ad_extendra:radium_block" }, // display block
        ["ad_extendra:radium_block"], // categories that this soil provides
