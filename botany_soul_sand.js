ServerEvents.recipes(event => {
    event.recipes.botanypots.crop(
        "minecraft:soul_sand", // seed item
        ["minecraft:soul_soil"], // categories that this crop can be planted on
        { block: "minecraft:soul_sand" }, // display block
        [
            Item.of ("minecraft:soul_sand") // item
    ...
    event.recipes.botanypots.soil(
        "minecraft:soul_soil", // the item that this soil is attached to
        { block: "minecraft:soul_soil" }, // display block
        ["minecraft:soul_soil"], // categories that this soil provides
